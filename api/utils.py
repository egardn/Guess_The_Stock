...
MODEL_PATH = os.getenv("MODEL_PATH", "../model_checkpoints_gru/final_model_gru.pkl")
PIPELINE_PATH = os.getenv("PIPELINE_PATH", "../preprocessed_data/gru_pipeline.pkl")

# Track API start time
app_start_time = datetime.now()

print(f"Uvicorn using Python executable: {sys.executable}")  # Add this line
